...
print("conversation gets more expensive per turn, and why §28.3's provider-side")
...
print("the volume at several times the price, which makes asking for shorter")
