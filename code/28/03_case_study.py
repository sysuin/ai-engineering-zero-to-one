...
print("which produces a cut-off answer at full price — §27.4's stop reason is how you")
...
print("fewer chances to retrieve the right one, so it trades cost against §22.6's")
