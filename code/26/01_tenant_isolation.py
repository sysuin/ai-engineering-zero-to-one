...
print()
print("Write it once per table and run it on every build. It is three lines, it is")
print("the only test that catches a missing WHERE clause, and a missing WHERE clause")
print("is the single most common way one customer sees another's data.")
print()
...
print("  row-level security    Postgres enforces the predicate itself, so even a")
print("                        hand-written query in a migration cannot cross")
print()
