...
print()
print(f"A breaker stops you paying for the outage. The dead primary was called "
      f"{primary.calls} times")
print(f"rather than ten, and the other {10 - primary.calls} requests went straight to the")
...
print("second model is good enough to serve your users unattended. §27.4 is how you")
