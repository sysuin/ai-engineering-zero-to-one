...
print("kernel gives a slightly different sum; when two tokens are nearly tied, a")
print("difference in the twelfth decimal place decides which one wins, and every")
print("token after it is downstream of that choice.")
print()
...
print("condition, and §24.2 is about what you do instead.")
