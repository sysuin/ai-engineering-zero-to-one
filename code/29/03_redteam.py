...
print()
print("What it is genuinely for is regression. The house-style attack in §29.2 landed")
...
print()
print("  every real incident becomes a case      the same discipline as §24.11, and")
